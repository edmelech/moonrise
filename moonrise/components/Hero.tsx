...
const Hero = () => {
  return (
    ...
    <div className="bg-custom-color text-white p-16 h-screen w-3/5 min-w-3/5 border-2 border-red-500">
      <h1 className="text-7xl font-bold pb-8 w-4/5">The high-water mark in civil engineering recruitment</h1>

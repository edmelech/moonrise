...
const Hero = () => {
  return (
    ...
    <div className="bg-green-800 text-white p-16 h-screen max-w-1/2 border-2 border-red-500">
    ...
    <div className="bg-green-800 text-white p-4 h-screen mx-auto border-2 border-red-500">
      <h1 className="text-3xl font-bold">I will be the carousel</h1>
      <p className="text-lg">A new way to discover and support indie creators moonrise. is a specialist talent partner in the US civil engineering industry. It is our sole mission to provide first class service to our clients, sourcing ideal candidates from niche markets, creating lasting business relationships. With a vast and expanding network of industry leaders and experts, we have the very best of US engineering talent right at our fingertips. With an emphasis on civil infrastructure, we are recruitment specialists in: Water/Wastewater, Water Treatment, Transportation, Water Resources, and Land Development engineering. We understand how important our clients' work is in creating a sustainable and  </p>
    </div>

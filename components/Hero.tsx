...
const Hero = () => {
  return (
    ...
    <div className="bg-custom-color text-white p-8 md:p-16 min-h-screen md:w-3/5 md:min-w-3/5 md:order-1  ">
      ...
      <p className="text-sm md:text-base lg:text-lg xl:text-lg font-light">moonrise. is a specialist talent partner in global infrastructure. It is our sole mission to provide first class service to our clients, sourcing ideal candidates from niche markets and creating lasting business relationships. Boasting a deep and expanding network of industry leaders and experts across Europe, North America, South America, Asia, Africa, and Australia, we have the very best talent right at our fingertips. With an emphasis on civil infrastructure, we are recruitment specialists in Engineering, Architecture, Real Estate, Construction, Automation and Controls, and Renewable Energy.</p> 
      <br />
